...
@section('title', 'Data Karyawan PT Sanema Safari Mulia')
...
<div class="container-fluid">
    ...
    <div class="col-12 mb-2">
      <div class="page-title-box justify-content-between d-flex align-items-center">
        <h4 class="mb-0" style="font-weight: bold;color:black">Data Karyawan</h4>
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a href="#" style="text-decoration: none">Data Karyawan</a></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <h5 class="mt-4 text-center" style="color: #000; font-weight: 300" >Seluruh <b style="font-weight: bold">data karyawan</b> yang ada di Database Aplikasi Penggajian PT Sanema Safari Mulia</h5>
    <!-- DataTales Example -->

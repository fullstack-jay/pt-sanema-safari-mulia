...
<div class="container-fluid">
    ...
    <div class="col-12 mb-2">
      <div class="page-title-box justify-content-between d-flex align-items-center">
        <h4 class="mb-0" style="font-weight: bold;color:black">Daftar Jabatan</h4>
    ...
    <h5 class="mt-4 text-center" style="color: #000; font-weight: 300" >Seluruh  <b style="font-weight: bold">daftar jabatan karyawan</b> yang ada di Database Aplikasi Penggajian PT Sanema Safari Mulia</h5>
    <!-- DataTales Example -->

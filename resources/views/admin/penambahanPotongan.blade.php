...
<div class="container-fluid">
  ...
  <div class="col-12 mb-2">
    <div class="page-title-box justify-content-between d-flex align-items-center">
      <h4 class="mb-0" style="font-weight: bold;color:black">Form Input Penambahan & Pengurangan Gaji</h4>
      <div class="page-title-right">
        <ol class="breadcrumb m-0">
          <li class="breadcrumb-item"><a href="#" style="text-decoration: none">Penambahan & Potongan</a></li>
        </ol>
      </div>
    </div>
  </div>
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-2">
                  <button title="Rumus" type="button" class="ml-3 btn btn-sm btn-light text-secondary"
                    data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-question-circle fa-2x"></i>
                  </button>
                </div>
              </div>
              ...
              <form action="{{ url('admin/potongan') }}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('npo') is-invalid @enderror" id="npo" name="npo"
                      value="{{ old('npo') }}">
                    @error('npo')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('rpo') is-invalid @enderror" id="rpo" name="rpo"
                      value="{{ old('rpo') }}">
                    @error('rpo')
                    <div class="invalid-feedback">
                      {{ $message }}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('spo') is-invalid @enderror" id="spo" name="spo"
                      value="{{ old('spo') }}">
                    @error('spo')
                    <div class="invalid-feedback">
                      {{ $message }}
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center align-middle p-0">
                        <button type="button" style="width:60px" class="btn btn-warning btn-sm mx-1 my-1"
                          data-toggle="modal" data-target="#exampleModalCenter{{ $po->id }}">Ubah</button>
                        <button type="button" class="btn btn-danger btn-sm d-inline my-1" style="width:60px"
                          data-toggle="modal" data-target="#exampleModalCenter2{{ $po->id }}">Hapus</button>
                      </td>
                    </tr>
                    <!-- Ubah Modal -->
                    <div class="modal fade" id="exampleModalCenter{{ $po->id }}" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <form action="{{ url('admin/potongan/'.$po->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group row">
                                <label for="npot" class="col-sm-4 col-form-label">Nama
                                  Potongan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('npot') is-invalid @enderror" id="npot"
                                    name="npot" value="{{ old('npot', $po->name) }}">
                                  @error('npot')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                <label for="rpot" class="col-sm-4 col-form-label">Rumus
                                  Potongan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('rpot') is-invalid @enderror" id="rpot"
                                    name="rpot" value="{{ old('rpot', $po->formula) }}">
                                  @error('rpot')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                <label for="spot" class="col-sm-4 col-form-label">Syarat
                                  Potongan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('spot') is-invalid @enderror" id="spot"
                                    name="spot" value="{{ old('spot', $po->condition) }}">
                                  @error('spot')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                    ...
                    {{-- Delete Modal --}}
                    <div class=" modal fade" id="exampleModalCenter2{{ $po->id }}" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-footer p-0 px-3">
                            ...
                            <form method="POST" action="{{ url('/admin/penambahan-potongan/'.$po->id) }}"
                              class="m-0 p-0">
                              @csrf
                              @method('delete')
            ...
            <div class="col-md-12">
              ...
              <form action="{{ url('admin/penambahan') }}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('np') is-invalid @enderror" id="np" name="np"
                      value="{{ old('np') }}">
                    @error('np')
                    <div class="invalid-feedback">
                      {{ $message }}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('rp') is-invalid @enderror" id="rp" name="rp">
                    @error('rp')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control @error('sp') is-invalid @enderror" id="sp" name="sp"
                      value="{{ old('sp') }}">
                    @error('sp')
                    <div class="invalid-feedback">
                      {{ $message }}
                ...
                <table class="table table-bordered" id="tablePenambahan" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center align-middle p-0">
                        <button type="button" class="btn btn-warning btn-sm mx-1 my-1" style="width:60px"
                          data-toggle="modal" data-target="#exampleModalCenter{{ $p->id }}">Ubah</button>
                        <button type=" button" class="btn btn-danger btn-sm d-inline my-1" style="width:60px"
                          data-toggle="modal" data-target="#exampleModalCenter2{{ $p->id }}">Hapus</button>
                      </td>
                    </tr>
                    <!-- Ubah Modal -->
                    <div class="modal fade" id="exampleModalCenter{{ $p->id }}" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group row">
                                <label for="npe" class="col-sm-4 col-form-label">Nama
                                  Penambahan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('npe') is-invalid @enderror" id="npe"
                                    name="npe" value="{{ old('npe', $p->name) }}">
                                  @error('npe')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                <label for="rpe" class="col-sm-4 col-form-label">Rumus
                                  Penambahan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('rpe') is-invalid @enderror" id="rpe"
                                    name="rpe" value="{{ old('rpe', $p->formula) }}">
                                  @error('rpe')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                <label for="spe" class="col-sm-4 col-form-label">Syarat
                                  Penambahan</label>
                                <div class="col-8">
                                  <input type="text" class="form-control @error('spe') is-invalid @enderror" id="spe"
                                    name="spe" value="{{ old('spe', $p->condition) }}">
                                  @error('spe')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                    ...
                    {{-- Delete Modal --}}
                    <div class=" modal fade" id="exampleModalCenter2{{ $p->id }}" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-footer p-0 px-3">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                            <form method="POST" action="{{ url('/admin/penambahan-potongan/'.$p->id) }}"
                              class="m-0 p-0">
                              @csrf
                              @method('delete')
                              <div class="form-group">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        contoh : a*100000 (ketidakhadiran * Rp.100.000)

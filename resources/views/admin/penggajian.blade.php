...
@section('title', 'Penggajian Karyawan PT Sanema Safari Mulia')
...
<div class="container-fluid">
  ...
  <div class="col-12 mb-2">
    <div class="page-title-box justify-content-between d-flex align-items-center">
      <h4 class="mb-0" style="font-weight: bold;color:black">Data Penggajian Karyawan</h4>
      <div class="page-title-right">
        <ol class="breadcrumb m-0">
          <li class="breadcrumb-item"><a href="#" style="text-decoration: none">Penggajian /</a></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-start mb-2">
    <div class="col-8 d-flex align-items-center">
      <h5 style="margin: 1rem 0.5rem;">Filter berdasarkan MM/YY :</h5>
      <form action={{ url('admin/penggajian') }} method="post">
        <div class="input-group mr-3 mt-3" style="height: 48px;">
          ...
          <select name="year" class="custom-select text-primary mr-3" style="text-align: center; font-weight: bolder;">
  ...
  <h5 class="mt-4 text-center" style="color: #000; font-weight: 300">Seluruh <b style="font-weight: bold">daftar
      penggajian karyawan</b> yang ada di Database Aplikasi Penggajian PT Sanema Safari Mulia</h5>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center align-middle">
                ...
                <button disabled type="submit" class="btn btn-primary btn-sm" style="width: 50px;" value="submit"
                  disabled title="Download Slip"><i class="fas fa-file-download fa-lg"></i></button>
              </td>
                    ...
                    <div class="modal-body text-dark">
                      <div class="row">
                        <div class="col-9 pl-5">
                          <h2 class="text-left text-dark font-weight-bold mb-0 mt-1">
                            PT Sanema Safari Mulia
                          </h2>
                          <p class="text-left text-dark">EMAIL : SANEMATOUR@GMAIL.COM</p>
                        </div>
                      ...
                      <div class="container text-monospace">
                        ...
                        <div class="row mt-3 py-0">
                          <div class="col-12 bg-primary text-light text-center font-weight-bold py-0">
            ...
            <tr>
              ...
              <td class="text-center align-middle">
                ...
                <form action="{{ url('admin/post/penggajian/'.$e->id)}}" method="POST" class="d-inline">
                  ...
                  <input type="hidden" name="penambahan" value={{ $hasilPenambahan[$row]+$e->position->job_allowance }}>
                  <input type="hidden" name="potongan" value={{ $hasilPotongan[$row] }}>
                  <input type="hidden" name="bersih" value={{
                    $e->position->salary+$e->position->job_allowance+$hasilPenambahan[$row]-$hasilPotongan[$row] }}>
                  <button type="submit" class="btn btn-primary btn-sm mt-1" style="width: 50px;" value="submit"
                ...
                @else
                <button disabled type="submit" class="btn btn-primary btn-sm mt-1" style="width: 50px;" value="submit"
                  title="Kirim Slip"><i class="fas fa-paper-plane fa-lg"></i></button>
                @endif
                @endif
              </td>
                  ...
                  <div class="modal-content">
                          ...
                          <div class="col-6">
                            <div class="row">
                              ...
                              <div class="col-5 p-0">
                                ...
                                <p class="text-left mb-0 mt-1 font-weight-bold" style="font-size: 12px">:
                                  &nbsp;Rp.
                                  {{ number_format($e->position->salary+$e->position->job_allowance+$totalPenambahan
                                  ,0,'','.') }}
                                </p>
                              </div>
                            </div>
                        ...
                        <div class="row mt-3 py-0">
                          <div class="col-12 bg-primary text-light text-center font-weight-bold py-0">
                            <h5 class="py-1 my-0">PENERIMAAN BERSIH
                              (A-B)&nbsp;&nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;Rp.
                              {{
                              number_format($e->position->salary+$e->position->job_allowance+$totalPenambahan-$totalPotongan
                              ,0,'','.') }}
                            </h5>
                          </div>
                        </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ url('admin/post/penggajian/'.$e->id)}}" method="POST" class="d-inline">
                        @csrf
                        <input type="hidden" name="gapok" value={{ $e->position->salary }}>
                        <input type="hidden" name="penambahan" value={{
                          $hasilPenambahan[$row]+$e->position->job_allowance }}>
                        <input type="hidden" name="potongan" value={{ $hasilPotongan[$row] }}>
                        <input type="hidden" name="bersih" value={{
                          $e->position->salary+$e->position->job_allowance+$hasilPenambahan[$row]-$hasilPotongan[$row]
                        }}>
                        <button type="submit" class="btn btn-primary mr-0" style="width: 60px;" value="submit"
                          title="Kirim Slip"><i class="fas fa-paper-plane fa-lg"></i></button>
                      </form>
                      @else
                      ...
                      <form action="{{ url('admin/post/penggajian/'.$e->id)}}" method="POST" class="d-inline">
                        ...
                        <button type="submit" class="btn btn-primary mr-0" style="width: 60px;" title="Kirim Slip"><i
                            class="fas fa-paper-plane fa-lg"></i></button>
                      </form>
                      @else
                      <button disabled type="submit" class="btn btn-primary mr-0" style="width: 60px;" value="submit"
                        title="Kirim Slip"><i class="fas fa-paper-plane fa-lg"></i></button>
                      @endif
                      @endif
                      <form action="{{ url('printPdf/'.$e->id.'/'.$postMonth.'/'.$postYear)}}" method="POST"
                        class="d-inline">
                        @csrf
                        <button type="submit" class="btn btn-warning ml-0" style="width: 60px" title="Download Slip"><i

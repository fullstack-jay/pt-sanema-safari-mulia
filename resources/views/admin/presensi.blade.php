...
@section('title', 'Presensi Karyawan PT Sanema Safari Mulia')
...
<div class="container-fluid">
  ...
  <div class="col-12 mb-2">
    <div class="page-title-box justify-content-between d-flex align-items-center">
      <h4 class="mb-0" style="font-weight: bold;color:black">Presensi Karyawan</h4>
      <div class="page-title-right">
        <ol class="breadcrumb m-0">
          <li class="breadcrumb-item"><a href="#" style="text-decoration: none">Presensi /</a></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-start mb-2">
    <div class="col-8 d-flex align-items-center">
      <h5 style="margin: 1rem 0.5rem;">Filter berdasarkan MM/DD/YY :</h5>
      <form action={{ url('admin/presensi') }} method="post">
        <div class="input-group daterange mr-3 mt-3" style="height: 48px;">
          @csrf
          <input type="date" name="tanggalAwal" style="text-align: center; font-weight: bolder;" min="{{ $min }}"
  ...
  <h5 class="mt-4 text-center" style="color: #000; font-weight: 300" >Seluruh  <b style="font-weight: bold">daftar presensi karyawan</b> yang ada di Database Aplikasi Penggajian PT Sanema Safari Mulia</h5>
        ...
        <table class="table table-bordered" id="dataTableAbsensi" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span style="display:none;">{{ Carbon\Carbon::parse($presence->created_at)->getTimestamp() }}</span>
              ...
              <td class="text-center">
                <form action="{{ url('admin/presensi/edit') }}" method="post">
                  ...
                  <button title="Edit Presensi" type="submit" class="btn btn-warning btn-sm mx-1" style="width: 60px;"
                    href="{{ url('admin/presensi/edit') }}" role="button"><i class="fas fa-fw fa-edit"></i></button>
                </form>
              </td>
            </tr>
            @endforeach

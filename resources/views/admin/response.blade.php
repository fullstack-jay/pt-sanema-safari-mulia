      ...
      <div class="container">
        <div class="row">
          <div class="col-10">
            ...
            <h6 class="mt-2">oleh : <a href="{{ url('admin/data-karyawan/'.$complaint->employee->id) }}">{{
                $complaint->employee->full_name }}</a>
            </h6>
          </div>
          ...
          <div class="col-12 text-justify">
            ...
            <a download="complaint-{{ $complaint->employee->full_name.'-'.$i->complaint_image }}"
              ...
              <img src="{{ asset('img/complaintImg/'.$i->complaint_image) }}"
                style="height: 85px; width: 85px; object-fit: cover; cursor: pointer;" class="img-thumbnail pop">
            </a>
        ...
        <form action="#">
          ...
          <div class="form-group row">
            <label for="judul" class="col-sm-2 col-form-label">Judul</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="judul" value="{{ $complaint->response->subject }}" readonly>
            </div>
          </div>
          <div class="form-group row">
            <label for="isi" class="col-sm-2 col-form-label">Isi</label>
            <div class="col-sm-10">
              <textarea class="form-control" id="isi" rows="3" readonly>{{ $complaint->response->response }}</textarea>
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="inlineFormCustomSelectPref">Status</label>

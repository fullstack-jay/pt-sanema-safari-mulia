...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-sanema sidebar sidebar-dark accordion" id="accordionSidebar">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <img src="{{ URL::asset('img/login/sanema.png') }}" alt="Sanema" width="70" height="70"
          style="background-color: white; width: auto; margin-bottom: 0.5rem">
      </a>
      ...
      <p class="credit">created by <span>Rizqi Reza Ardiansyah</span> | all rights reserved </p>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <div class="nav-link">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->user()->employee->full_name
                  }}</span>

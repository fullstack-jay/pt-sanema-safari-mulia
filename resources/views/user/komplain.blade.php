              ...
              <form action="{{ url('komplain') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                  <input type="text" aria-describedby="basic-addon1"
                    class="form-control uang @error('judul') is-invalid @enderror" id="judul" name="judul"
                ...
                <div class="input-group mb-3">
                  <textarea class="form-control here @error('isi') is-invalid @enderror" id="isi" name="isi"
              ...
              <div class="table-responsive">
                <table class="table table-hover" width="100%" cellspacing="0">
                  <tbody>
                    ...
                    <tr
                      class="clickable-row @if(!empty($c->response)) @if($c->response->status == 1) bg-success text-white @else bg-danger @endif @else bg-light text-dark @endif"

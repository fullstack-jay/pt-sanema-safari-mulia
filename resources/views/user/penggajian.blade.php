...
<div class="container-fluid">
  ...
  <h5 class="mt-4 text-center" style="color: #000; font-weight: 300" >Seluruh  <b style="font-weight: bold">daftar penggajian karyawan</b> yang ada di Database Aplikasi Penggajian PT Sanema Safari Mulia</h5>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center align-middle">
                <button type="button" class="btn btn-info btn-sm" style="width: 50px;" data-toggle="modal"
                  data-target=".bd-example-modal-lg{{ $e->id }}" title="Info Gaji"><i
                    ...
                    <div class="modal-body text-dark">
                      <div class="row">
                        ...
                        <div class="col-3 pr-4">
                          <img src="{{ asset('img/login/sanema.png') }}" height="80px;">
                        </div>
                      </div>
              ...
              <td class="text-center align-middle">
                <button title="Info Gaji" type="button" class="btn btn-info btn-sm" style="width: 50px;"
                  data-toggle="modal" data-target=".bd-example-modal-lg{{ $e->id }}"><i
                    class="fas fa-info-circle fa-lg"></i></button>
                <form action="{{ url('printPdf/'.$e->id.'/'.$postMonth.'/'.$postYear.'/employee')}}" method="POST"
                  class="d-inline">
                  @csrf
                  <button type="submit" class="btn btn-primary btn-sm" style="width: 50px;" title="Download Slip"><i

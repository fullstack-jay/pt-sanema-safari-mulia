...
<div class="container-fluid">
  <div class="card">
    <div class="card-body overflow-auto pb-0 pt-3">
      <h4>{{ Carbon\Carbon::now()->locale('id')->dayName.', '.Carbon\Carbon::now()->day.'
        '.Carbon\Carbon::now()->locale('id')->monthName.' '.Carbon\Carbon::now()->year}}
      </h4>
      <div class="row mb-4">
        ...
        <div class="col-12 justify-content-center d-flex">
          ...
          <button class="btn btn-sm btn-secondary rounded-pill font-weight-bold"
            style="width: 400px; height: 56px; font-size: 32px;" disabled>{{ session()->get('sudah') }}
          </button>
          ...
          <form action="{{ url('presensi') }}" method="post">
            ...
            <button class="btn btn-sm btn-secondary rounded-pill font-weight-bold"
              style="width: 360px; height: 56px; font-size: 32px;" disabled>DILUAR JAM MASUK
            </button>
            ...
            <button type="submit" class="btn btn-sm btn-primary rounded-pill font-weight-bold"
              style="width: 240px; height: 56px; font-size: 32px;">ABSEN
            </button>

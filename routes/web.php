...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('admin/akun/kelola-akun', 'UserController@index'); //View kelolaAkun

    Route::get('admin/akun/input-akun', 'UserController@create'); //View inputAkun
